...
if not api_key:
    logger.error("API key is not found. Please set the GEMINI_API_KEY environment variable.")
    # For local testing, you might temporarily set it here, but ideally it should be external.
...
def ats_extractor(resume_data_text):
    ...
    From the given resume text, extract the following information and return it in valid JSON format:
    {
        "Full Name": "",
        "Email Address": "",
        "Phone Number": "",
