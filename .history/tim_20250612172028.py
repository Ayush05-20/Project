...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Web Scraper Tool - Extracts specific information from websites",
        epilog="""
Examples:
  python tim.py "https://example.com/jobs" "Extract all job titles and their salaries"
  python tim.py "https://news-site.com" "Extract all news headlines from today"
  python tim.py "https://tech-blog.com" "Extract all article titles and their authors"
        """
    )
    
    parser.add_argument(
        "url",
        help="The website URL to scrape (include http:// or https://)"
    )
    
    parser.add_argument(
        "parse_description",
        help="Describe what information you want to extract (e.g., 'Extract all job titles', 'Find contact information')"
    )
